...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "VASTRIKA — Luxury handcrafted sarees. Banarasi, Kanjivaram, Organza and bridal heirlooms woven by master artisans of India." },
      { name: "author", content: "VASTRIKA" },
      { property: "og:title", content: "VASTRIKA — Timeless Elegance" },
      { property: "og:description", content: "Heirloom sarees, handwoven by India's master artisans." },
